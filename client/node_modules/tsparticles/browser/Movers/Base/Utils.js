...
export function spin(particle, moveSpeed) {
    ...
    const updateFunc = {
        x: particle.spin.direction === "clockwise" /* clockwise */ ? Math.cos : Math.sin,
        y: particle.spin.direction === "clockwise" /* clockwise */ ? Math.sin : Math.cos,
    };
...
export function getProximitySpeedFactor(particle) {
    ...
    const active = isInArray("slow" /* slow */, options.interactivity.events.onHover.mode);
    if (!active) {
        return 1;
    }
