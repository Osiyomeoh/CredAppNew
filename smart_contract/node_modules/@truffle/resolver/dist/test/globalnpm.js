...
(0, mocha_1.describe)("globalnpm", () => {
    (0, mocha_1.describe)("require function", () => {
        let syncStub;
        ...
        (0, mocha_1.it)("returns null if the import_path starts with '.'", () => {
            const result = globalNpm.require("./A.sol");
            assert_1.default.deepEqual(result, null);
        });
        (0, mocha_1.it)("returns null if the import_path is absolute path", () => {
            const result = globalNpm.require("/A.sol");
            assert_1.default.deepEqual(result, null);
        });
        (0, mocha_1.it)("returns the contents of json (in build/contracts)", () => {
        ...
        (0, mocha_1.it)("returns the contents of json (in build dir)", () => {
        ...
        (0, mocha_1.it)("returns undefined if the import_path does not exist", () => {
        ...
        (0, mocha_1.it)("returns null if readFileSync throws Error", () => {
    ...
    (0, mocha_1.describe)("resolve function", () => {
        let syncStub;
        let getInstalledPathSyncStub;
        beforeEach(() => {
            syncStub = sinon.stub(detectInstalled, "sync");
        ...
        (0, mocha_1.it)("returns the contents of solidity file if the import_path exists", () => __awaiter(void 0, void 0, void 0, function* () {
            syncStub.withArgs("package").returns(true);
            getInstalledPathSyncStub
                .withArgs("package")
                .returns(path_1.default.resolve(__dirname, "fixtures/globalnpm/node_modules/package"));
        ...
        (0, mocha_1.it)("returns undefined body if the package does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            syncStub.withArgs("package").returns(false);
            getInstalledPathSyncStub
                .withArgs("package")
                .returns(path_1.default.resolve(__dirname, "fixtures/globalnpm/node_modules/package"));
        ...
        (0, mocha_1.it)("returns undefined body if readFileSync throws Error", () => __awaiter(void 0, void 0, void 0, function* () {
            const readFileSyncStub = sinon.stub(fs_1.default, "readFileSync");
            syncStub.withArgs("package").returns(true);
            getInstalledPathSyncStub
                .withArgs("package")
